"""
Django settings for aws_django_test1 project.
...
SECRET_KEY = 'z=1#npk-!7mw3mg0$j_=3(dcgho&bt%p$53pnt!()dm$pxgebi'
...
ROOT_URLCONF = 'aws_django_test1.urls'
...
WSGI_APPLICATION = 'aws_django_test1.wsgi.application'
